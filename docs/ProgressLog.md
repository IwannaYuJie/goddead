...
- No state keys, unlock contracts, guards, counters, audio engine, hash routing or cross-scene linkage were changed. Cache bumped to `v21`; static tests extended with asset existence/references, threshold door button/img contract and old SVG geometry removal.
